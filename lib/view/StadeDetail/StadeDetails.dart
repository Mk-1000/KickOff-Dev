                    ...
                    Column(
                      ...
                      children: [
                        Column(
                           crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
  AllText.Autotext(text: "May foot land", fontSize: 24, fontWeight: FontWeight.w600, color: Color(0xFF000B3A)),
                        SizedBox(height: 8),
                        Row(
                          children: [
     ...
     Row(
                        ...
                        Column(
                         ...
                         AllText.Autotext(text: "Telephone", fontSize: 16, fontWeight: FontWeight.w300, color: Color(0xFF9698A9)),
                          SizedBox(height: 8),
                         AllText.Autotext(text: "94 345 233", fontSize: 16, fontWeight: FontWeight.w500, color: Color(0xFF000B3A)),
                        ],),
                         Container(
                        height:48 ,
                        width: 48,
