    ...
    return Container(
      ...
      child: Column(
        ...
        Container(
          ...
          child: AllText.Autotext(text: "Annoncer votre équipe", fontSize: 18, fontWeight: FontWeight.w700, color: Theme.of(context).shadowColor)), 
        SizedBox(height: 32,),
        AllText.Autotext(text: "Select Your Team", fontSize: 16, fontWeight: FontWeight.w400, color:Theme.of(context).shadowColor ),
           SizedBox(height: 12,),
        DropDownTeam( list: ["hi", "heyy"],),
        SizedBox(height: 24,),
                AllText.Autotext(text: "Select Your stade", fontSize: 16, fontWeight: FontWeight.w400, color:Theme.of(context).shadowColor ),
                    SizedBox(height: 12,),
        Row(
        ...
        SizedBox(height: 8,),
        DropDuwnButton(list: ville, width: double.infinity,),
      ],),
    );
  }
}