...
import 'package:takwira/presentation/view/Teamview/TeamView.dart';
import 'package:takwira/presentation/view/VsView/VsView.dart';
...
class RechrcheEquipe extends StatefulWidget {
  ...
  final int Index ; 
  final bool vs ; 
  const RechrcheEquipe({super.key, required this.send, required this.Index, required this.vs});
...
class _RechrcheEquipeState extends State<RechrcheEquipe> {
 ...
 Navigator.push(
    context,
    MaterialPageRoute(builder: (context) =>  Vsview(invit: true,)),
  );
        }else {
 Navigator.push(
    context,
    MaterialPageRoute(builder: (context) =>  TeamView(invit: true,)),
  );
        }
